...
function initialize() {
    ...
    if (buttonLocation === undefined) {
        if (initRetries < MAX_INIT_RETRIES) {
            initRetries++;
            world.sendMessage("Waiting for chunks to load near spawn (attempt " + initRetries + " of " + MAX_INIT_RETRIES + ")");
    ...
    world.sendMessage("Press the button at X:" + buttonLocation.x + " Y:" + buttonLocation.y + " Z:" + buttonLocation.z + " to start!");
}
